/**
 * ATF Jets — Database Seed Script
 * Run: npx ts-node src/scripts/seed.ts
 *
 * Creates:
 * - Admin + Christian Maier customer account
 * - 6 Private Jets
 * - 10 past completed flights/bookings for Christian Maier
 * - 5 future available flights
 * - Promo codes
 */
import mongoose from "mongoose";

const MONGODB_URI = process.env.MONGODB_URI || "mongodb://localhost:27017/atf-jets";
...
async function seed() {
  ...
  const users = await User.create([
    ...
    },
    {
      ...
      loyaltyPoints: 0, // Will be set after calculating bookings
      totalFlights: 0,
      totalSpent: 0,
    },
    {
  ...
  const jets = await Aircraft.create([
    {
      ...
      seatConfiguration: [
        {
          ...
          layout: "club",
          pitch: "N/A",
          features: ["Wi-Fi", "Refreshment Center", "Club Seating", "Lavatory"],
        },
      ],
      ...
      homeBase: "TEB",
      isAvailable: true,
      images: ["/images/fleet/citation-x.jpg"],
    },
    {
      registration: "ATF-CH350-01",
      ...
      seatConfiguration: [
        {
          ...
          layout: "club",
          pitch: "N/A",
          features: ["Wi-Fi", "Full Galley", "Flat-Floor Cabin", "In-Flight Baggage Access"],
        },
      ],
      ...
      homeBase: "LHR",
      isAvailable: true,
      images: ["/images/fleet/challenger-350.jpg"],
    },
    {
      registration: "ATF-G650-01",
      ...
      seatConfiguration: [
        {
          ...
          layout: "club",
          pitch: "N/A",
          features: ["Ka-band Wi-Fi", "Master Suite", "Shower", "Conference Area", "Entertainment System"],
        },
      ],
      ...
      homeBase: "DXB",
      isAvailable: true,
      images: ["/images/fleet/g650.jpg"],
    },
    {
      registration: "ATF-F8X-01",
      ...
      seatConfiguration: [
        {
          ...
          layout: "club",
          pitch: "N/A",
          features: ["Wi-Fi", "Three Lounge Areas", "Crew Rest", "Skylight"],
        },
      ],
      ...
      homeBase: "CDG",
      isAvailable: true,
      images: ["/images/fleet/falcon-8x.jpg"],
    },
    {
      registration: "ATF-P600-01",
      ...
      seatConfiguration: [
        {
          ...
          layout: "club",
          pitch: "N/A",
          features: ["Wi-Fi", "Full Galley", "Flat-Floor Cabin", "Stone Floor Lavatory"],
        },
      ],
      ...
      homeBase: "JFK",
      isAvailable: true,
      images: ["/images/fleet/praetor-600.jpg"],
    },
    {
      registration: "ATF-G7500-01",
      ...
      seatConfiguration: [
        {
          ...
          layout: "club",
          pitch: "N/A",
          features: ["Four Living Spaces", "Full Kitchen", "Master Suite", "Shower", "Crew Suite"],
        },
      ],
      ...
      homeBase: "ZRH",
      isAvailable: true,
      images: ["/images/fleet/global-7500.jpg"],
    },
  ]);
  console.log(`  Created ${jets.length} private jets`);
  ...
  await Crew.create([
    {
      ...
      monthlyFlightHours: 45,
      maxMonthlyHours: 100,
      homeBase: "LHR",
      contactEmergency: { name: "Margaret Harrison", relation: "Spouse", phone: "+44 7700 900123" },
      schedule: [],
    },
    {
      user: users[3]._id,
      employeeId: "ATF-FA-001",
      role: "purser",
      status: "available",
      ...
      monthlyFlightHours: 60,
      maxMonthlyHours: 100,
      homeBase: "LHR",
      contactEmergency: { name: "David Williams", relation: "Father", phone: "+44 7700 900456" },
      schedule: [],
    },
  ]);
  console.log("  Created 2 crew members");

  // ── Past Travel History for Christian Maier (10 completed trips) ──
  console.log("Creating past travel history for Christian Maier...");
  ...
  for (const trip of pastTrips) {
    ...
    const pointsEarned = Math.floor(total * 10 * 2); // platinum 2x multiplier
    ...
    const flight = await Flight.create({
      flightNumber: trip.num,
      type: "private-jet",
      airline: "ATF Jets",
      departure: {
        airport: trip.depCity + " International",
        airportCode: trip.depCode,
        city: trip.depCity,
        country: trip.depCountry,
        terminal: "Private",
        gate: "FBO",
      ...
      arrival: {
        airport: trip.arrCity + " International",
        airportCode: trip.arrCode,
        city: trip.arrCity,
        country: trip.arrCountry,
        terminal: "Private",
        scheduledTime: arrDate,
        actualTime: arrDate,
        timezone: trip.arrTz,
      },
      duration: trip.dur,
      ...
      seatMap: [
        {
          class: "first",
          rows: 1,
          seatsPerRow: jet.specs.maxPassengers,
          totalSeats: jet.specs.maxPassengers,
          availableSeats: 0,
          price: baseFare,
          layout: "club",
        },
      ...
      baggageAllowance: { cabin: { weight: 15, pieces: 2 }, checked: { weight: 50, pieces: 3 } },
      stops: 0,
      isActive: false,
    });
  ...
  // Update Christian Maier's stats
  await User.findByIdAndUpdate(christian._id, {
    totalFlights: 10,
    totalSpent: Math.round(totalSpent * 100) / 100,
    loyaltyPoints: totalPoints,
  });

  console.log(`  Created 10 past bookings (Total spent: $${Math.round(totalSpent).toLocaleString()})`);

  // ── Future Available Flights ──
  console.log("Creating future flights...");
  const now = new Date();
  ...
  for (const f of futureFlights) {
    ...
    await Flight.create({
      ...
      airline: "ATF Jets",
      departure: {
        airport: f.dep.city + " International",
        airportCode: f.dep.code,
        city: f.dep.city,
        country: f.dep.country,
        terminal: "Private",
        gate: "FBO",
        scheduledTime: f.dTime,
        timezone: f.dep.tz,
      },
      arrival: {
        airport: f.arr.city + " International",
        airportCode: f.arr.code,
        city: f.arr.city,
        country: f.arr.country,
        terminal: "Private",
      ...
      seatMap: [
        {
          ...
          seatsPerRow: jet.specs.maxPassengers,
          totalSeats: jet.specs.maxPassengers,
          availableSeats: jet.specs.maxPassengers,
          price,
          layout: "club",
        },
      ],
  ...
  console.log(`  Created ${futureFlights.length} future flights`);
  ...
  console.log("\nTest Accounts:");
  console.log("  Admin:    admin@atfjets.com / Admin@2026!");
  console.log("  Customer: christian.maier@email.com / Maier@1965!");
  console.log("  Pilot:    captain@atfjets.com / Pilot@2026!");
  console.log("  Crew:     crew@atfjets.com / Crew@2026!");
  console.log("\nChristian Maier Stats:");
  console.log(`  Total Spent: $${Math.round(totalSpent).toLocaleString()}`);
  console.log(`  Loyalty Points: ${totalPoints.toLocaleString()}`);
  console.log(`  Past Flights: 10`);
  console.log(`  Future Flights Available: ${futureFlights.length}`);
  console.log("\nPromo Codes: WELCOME20, CHARTER500, ATFJETS10");
