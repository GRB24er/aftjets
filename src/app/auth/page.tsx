      ...
      <div style={{ width: "45%", minHeight: "100vh", position: "relative", overflow: "hidden", background: `linear-gradient(135deg, ${C.bg}, #0c0a2a, #0a1628)`, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", padding: 60 }}>
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: 400 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 14, marginBottom: 40 }}>
            <img src="/images/logo.svg" alt="ATF Jets" style={{ width: 56, height: 56, borderRadius: 16, objectFit: "contain", animation: "float 6s ease-in-out infinite" }} />
            <div style={{ textAlign: "left" }}><div style={{ fontSize: 28, fontWeight: 800, letterSpacing: 4 }}>ATF</div><div style={{ fontSize: 10, letterSpacing: 6, color: C.accentLight, fontWeight: 600 }}>JETS</div></div>
          </div>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: 40 }}>
        <div style={{ width: "100%", maxWidth: 440, animation: "fadeUp 0.5s ease-out both" }} key={page}>
          ...
          {page === "register" && (<>
            ...
            <p style={{ fontSize: 13, color: C.textDim, marginBottom: 28 }}>Join ATF Jets and start earning rewards</p>
          ...
          <div style={{ marginTop: 40, textAlign: "center", fontSize: 11, color: C.textDim }}>© 2026 ATF Jets. All rights reserved.</div>
        </div>
      </div>
    </div>
  );
