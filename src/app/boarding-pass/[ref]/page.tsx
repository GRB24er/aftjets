...
// ═══════════════════════════════════════════════════════════════════════
// ATF JETS — Premium Boarding Pass Generator
...
export default function BoardingPassPage({ params }: { params: { ref: string } }) {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      // ── Save ──
      doc.save(`ATF_BoardingPass_${data.bookingReference}_${data.passengerLastName}.pdf`);
    } catch (e) {
      ...
      <div className="bp-card" style={{ maxWidth: 820, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
          <div>
            <h1 style={{ color: C.text, margin: 0, fontSize: 24, fontWeight: 700, letterSpacing: 1 }}>
              ATF <span style={{ color: C.accent, fontSize: 12, letterSpacing: 3 }}>JETS</span>
            </h1>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              <div style={{ color: "#fff", fontSize: 16, fontWeight: 700, letterSpacing: 2 }}>ATF JETS</div>
        ...
        {data.loungeAccess && (
          <div style={{
            ...
            <div>
              ...
              <div style={{ color: C.sub, fontSize: 11 }}>Present your boarding pass at any ATF Jets partner lounge</div>
            </div>
          </div>
        )}
      </div>
