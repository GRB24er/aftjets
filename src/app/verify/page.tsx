      ...
      <div className="verify-card" style={{ maxWidth: 560, margin: "0 auto" }}>
        ...
        {!ref && !result && (
          <div style={{ background: C.card, border: "1px solid " + C.border, borderRadius: 16, padding: 32, textAlign: "center" }}>
            ...
            <p style={{ color: C.sub, fontSize: 13, marginBottom: 24 }}>Scan an ATF Jets boarding pass QR code or enter a booking reference manually.</p>
        ...
        {result && !loading && (
          <div style={{ background: C.card, border: "1px solid " + C.border, borderRadius: 16, overflow: "hidden" }}>
            ...
            <div style={{
              ...
              {result.verified ? (
                <>
                  ...
                  <p style={{ color: C.sub, fontSize: 12, margin: 0 }}>This boarding pass has been verified by ATF Jets</p>
                </>
              ) : (
                <>
            ...
            <div style={{ borderTop: "1px solid " + C.border, padding: "14px 24px", textAlign: "center" }}>
              <div style={{ color: C.muted, fontSize: 10 }}>ATF Jets Digital Verification System</div>
              {!result.verified && (
