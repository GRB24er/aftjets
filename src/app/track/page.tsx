  ...
  return (
    <div style={{minHeight:"100vh",background:C.bg,display:"flex",alignItems:"center",justifyContent:"center",padding:20,fontFamily:"'Segoe UI',Arial,sans-serif"}}>
      <div style={{textAlign:"center",maxWidth:480}}>
        <div style={{fontSize:22,fontWeight:700,letterSpacing:3,color:C.text,marginBottom:4}}>ATF <span style={{color:C.accent,fontSize:10,letterSpacing:3}}>JETS</span></div>
        ...
        <div style={{background:C.card,border:"1px solid "+C.border,borderRadius:16,padding:32}}>
          ...
          <div style={{display:"flex",gap:10}}>
            <input value={ref} onChange={e=>setRef(e.target.value.toUpperCase())} placeholder="e.g. ATF-AB1234"
