...
const notifications = [
  { id: 1, type: "alert", title: "ATF 788 — Weather Advisory", message: "Severe turbulence forecast on JFK→NRT route FL340-380. Alternate routing recommended via northern Pacific track.", time: "2 min ago", read: false, priority: "high" },
  { id: 2, type: "booking", title: "New Booking — ATF-M4P2K7", message: "Takeshi Yamamoto booked G700 charter LHR→NCE for Feb 28. Diamond tier. $25,600 confirmed via bank transfer.", time: "12 min ago", read: false, priority: "normal" },
  ...
  { id: 4, type: "flight", title: "ATF 401 — Gate Change", message: "LHR→DXB gate changed from A14 to A18 due to aircraft repositioning. All PAX notified via push notification.", time: "45 min ago", read: false, priority: "normal" },
  ...
  { id: 7, type: "booking", title: "Booking Cancelled — ATF-F2H9V1", message: "Maria Santos cancelled SIN→ZRH business class. Refund of $5,100 processed to original payment method.", time: "3 hrs ago", read: true, priority: "normal" },
  { id: 8, type: "flight", title: "ATF 215 Departed On-Time", message: "SIN→ZRH departed Gate C12 at 14:30 SGT. 248 PAX, Capt. Weber commanding. ETA 21:15 CET.", time: "4 hrs ago", read: true, priority: "low" },
  { id: 9, type: "alert", title: "Fleet — Cessna CX+ Maintenance", message: "ATF-CX+01 C-Check overdue by 12 hours. Aircraft grounded at LHR maintenance hangar. Engineer team dispatched.", time: "5 hrs ago", read: true, priority: "high" },
