...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const userInitials = user ? `${user.firstName[0]}${user.lastName[0]}` : "ATF";
      ...
      <aside style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            overflow: "hidden",
          }}><img src="/images/logo.svg" alt="ATF Jets" style={{width:"100%",height:"100%",objectFit:"contain"}} /></div>
          {!collapsed && (
            <div>
              <div style={{ fontSize: 16, fontWeight: 800, letterSpacing: 3, color: C.text, lineHeight: 1 }}>ATF</div>
