        ...
        <div style={{ flex: 1, maxWidth: 700 }} key={tab}>
          {tab === "general" && (
            <div style={{ background: C.card, border: `1px solid ${C.glassBorder}`, borderRadius: 20, padding: "28px 30px", animation: "fadeUp 0.3s ease-out both" }}>
              ...
              <InputField label="AIRLINE NAME" value="ATF Jets" />
              ...
              <InputField label="SUPPORT EMAIL" value="support@atfjets.com" />
          ...
          {tab === "email" && (
            <div style={{ background: C.card, border: `1px solid ${C.glassBorder}`, borderRadius: 20, padding: "28px 30px", animation: "fadeUp 0.3s ease-out both" }}>
              ...
              <InputField label="SMTP HOST" value="smtp.atfjets.com" mono />
              <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 10 }}>
                <InputField label="SMTP USER" value="noreply@atfjets.com" mono />
                <InputField label="SMTP PORT" value="587" mono />
              </div>
              <InputField label="SMTP PASSWORD" value="••••••••••••" type="password" mono />
              <InputField label="FROM NAME" value="ATF Jets" />
              <InputField label="FROM EMAIL" value="noreply@atfjets.com" mono />
